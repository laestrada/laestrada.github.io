...
Amounts are approximate and can be adjusted to taste. Use ripe plantains for a sweeter mangú.
...
1. Add the onions to the pan and sauté until soft.
1. Pour the olive oil and vinegar mixture over the mashed plantains with each serving.
### Variation

Cook eggs in the pan with the onions and serve them with the mangú.
